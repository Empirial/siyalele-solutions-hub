...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      images: [
        "/loveable-uploads/Electronics Accessory Electrical engineering Electronic engineering Electronic component, alcohol lamp, electronics, electrical Wires Cable, engineering png.jpeg",
        "/loveable-uploads/OfficeS.jpeg",
        "/loveable-uploads/3d Set Of Construction Materials And Tools Materials For Construction 3d Illustration, Construction, 3d, Tool PNG Transparent Image and Clipart for Free Download.jpeg"
      ],
    },
    {
      icon: Leaf,
